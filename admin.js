...
(function(){
  ...
  async function createProduct(product){
    try{
      ...
      return true;
    } catch(err){ console.error('createProduct error:', err); showSnack('Failed to add product'); return false; }
  }
  async function updateProduct(productId, updates){
    try{
      ...
      return true;
    } catch(err){ console.error('updateProduct error:', err); showSnack('Failed to update product'); return false; }
  }
